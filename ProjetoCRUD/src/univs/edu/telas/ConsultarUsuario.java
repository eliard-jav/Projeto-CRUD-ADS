...
public class ConsultarUsuario extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
           ...
           if(linha == -1){
               JOptionPane.showInputDialog(null,"Selecione uma linha");
           }else if(JOptionPane.showConfirmDialog(null,"Deseja excluir esse usuário","Excluir", JOptionPane.YES_NO_OPTION) != JOptionPane.YES_OPTION){
